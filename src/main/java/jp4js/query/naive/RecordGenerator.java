...
public class RecordGenerator {
    ...
    Helper Functions
    */
    public static void transformByProperties(Record record, List<String> properties, RecordSet newData, Configuration configuration) {
    ...
    public static void transformByIndicies(Record record, List<Integer> indices, RecordSet newData, Configuration configuration) {
    ...
    public static void transformByWildcard(Record record, RecordSet newData, Configuration configuration) {
    ...
    private static void iterateJsonAndSelectProperties(String path, Object json, List<String> properties, RecordSet newData, Configuration configuration) {
    ...
    private static void transformByScan(Record record, List<String> properties, RecordSet newData, Configuration configuration) {
